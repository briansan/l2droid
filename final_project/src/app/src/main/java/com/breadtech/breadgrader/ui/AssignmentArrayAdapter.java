...
public class AssignmentArrayAdapter extends ArrayAdapter<Assignment>
{
     ...
     */
    public AssignmentArrayAdapter( Context ctxt, int res, ArrayList<Assignment> items) {
    ...
    public View getView( int pos, View v, ViewGroup p ) {
        ...
        Cell cell;
        // get the player
        Assignment course = getItem(pos);

        // if the view doesn't exist yet...
        if (v == null) {
            // inflate the view from the R.layout for the player cell
            v = LayoutInflater.from(this.getContext()).inflate(R.layout.assignment_list_item, p, false);
            ...
            cell.due_label = (TextView)v.findViewById(R.id.due_label);
        ...
        cell.title_label.setText(""+ course.index + ". " + course.name);
        cell.due_label.setText(df.format(course.due));
        cell.grade_label.setText(course.grade.toString());
