...
public class CourseArrayAdapter extends ArrayAdapter<Course>
{
     ...
     */
    public CourseArrayAdapter( Context ctxt, int res, ArrayList<Course> items) {
    ...
    public View getView( int pos, View v, ViewGroup p ) {
        ...
        if (v == null) {
            ...
            v = LayoutInflater.from(this.getContext()).inflate(R.layout.course_list_item, p, false);
            ...
            cell.subject_label = (TextView)v.findViewById(R.id.subject_label);
        ...
        cell.title_label.setText(course.title);
        cell.subject_label.setText(course.subject);
